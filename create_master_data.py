...
build_workbook("buyer-master-data.xlsx", [
    ("Buyer_Profiles",
     ...
     [12, 20, 26, 16, 16, 16, 14, 12, 14, 8, 14, 14, 12, 18]),
...
build_workbook("product-master-data.xlsx", [
    ("Product_Master",
     ...
     [16, 40, 14, 10, 9, 18, 16, 12, 12, 10, 16, 11, 8, 10, 13, 12, 14, 10, 10, 22]),
...
build_workbook("compliance-master-data.xlsx", [
    ("Compliance_Rules",
     ...
     ["rule_id", "sku", "product_family", "restriction_type", "region_state",
      "status", "reason", "approval_required", "authority", "eligible_flag", "required_doc_type"],
     [
        ["CMP-001", "SKU-FIN-9100", "FINISH", "REGIONAL", "CA", "RESTRICTED", "VOC limits in California (CARB)", "Y", "EPA/CARB", "N", "SDS"],
        ["CMP-002", "SKU-FIN-9100", "FINISH", "REGIONAL", "NY", "ALLOWED", "Permitted with SDS attached", "N", "EPA", "Y", "SDS"],
        ["CMP-003", "", "FINISH", "EXPORT", "MX", "PROHIBITED", "Export licence required - not held", "Y", "Customs", "N", "Export Licence"],
        ["CMP-004", "SKU-SHS-7700", "SHOWERSYS", "REGIONAL", "ALL", "ALLOWED", "No restriction", "N", "-", "Y", ""],
     ],
     [10, 16, 14, 14, 12, 12, 32, 16, 12, 11, 16]),
...
build_workbook("pricing-master-data.xlsx", [
    ...
    ("Contracts",
     ...
     [
        ...
        ["CONTRACT-PCBK-2026-010", "CUST-5001", "family", "CARTRIDGE", 11.90, "USD", "2026-01-01", "2026-12-31", "ACTIVE", 18],
     ],
     [24, 16, 12, 16, 14, 8, 12, 12, 10, 14]),
    ...
    ("Surcharges",
     ...
     ["surcharge_id", "scope_type", "scope_id", "surcharge_type", "amount_type", "amount", "reason",
      "region", "valid_from", "valid_to"],
     [
        ["SUR-LA-001", "zip", "90001", "REGIONAL_FEE", "PCT", 1.5, "West coast handling surcharge", "West", "2026-01-01", "2026-12-31"],
        ["SUR-FUEL-01", "ALL", "ALL", "FUEL", "PCT", 0.75, "Fuel adjustment", "ALL", "2026-01-01", "2026-12-31"],
     ],
     [14, 12, 14, 16, 12, 10, 28, 10, 12, 12]),
...
build_workbook("budget-master-data.xlsx", [
    ...
    ("Approvers",
     "APPROVERS  (named approvers, role, contact, approval limit)",
     ["approver_id", "approver_name", "role", "email", "approval_limit_amount", "status"],
     [
        ["APR-501", "Karen Wells", "BRANCH_MANAGER", "karen.wells@glps.com", 50000, "ACTIVE"],
        ["APR-502", "David Cho", "REGIONAL_MANAGER", "david.cho@glps.com", 250000, "ACTIVE"],
        ["APR-503", "Ana Reyes", "BRANCH_MANAGER", "ana.reyes@pcbk.com", 60000, "ACTIVE"],
        ["APR-504", "Procurement Board", "CORPORATE_PROCUREMENT", "procurement.board@continental-bpg.com", 99999999, "ACTIVE"],
     ],
     [12, 20, 22, 30, 20, 10]),
])
