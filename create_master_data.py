...
mock every "Systems / Data Needed" input. The canonical product catalog covers
kitchen & bath fixtures, fittings, fixtures cartridges, finishes and a premium
digital shower system. The happy-path customer (CUST-1001 / branch BR-GLP-MW /
ship-to ZIP 60639) is kept consistent across every workbook so the end-to-end
...
build_workbook("buyer-master-data.xlsx", [
    ("Buyer_Profiles",
     ...
     [
        ["BUY-001", "John Miller", "john.miller@glps.com", "CUST-1001", "BR-GLP-MW", "CC-MW-100", "SENIOR_BUYER", "ACTIVE", 250000, "USD", "Y", "PUNCH-GL-001"],
        ["BUY-002", "Linda Park", "linda.park@glps.com", "CUST-1001", "BR-GLP-MW", "CC-MW-200", "JUNIOR_BUYER", "ACTIVE", 5000, "USD", "N", "PUNCH-GL-002"],
        ["BUY-003", "Mark Snow", "mark.snow@ekbd.com", "CUST-1002", "BR-GLP-NE", "CC-NE-100", "BUYER", "ACTIVE", 75000, "USD", "Y", "PUNCH-EK-003"],
        ["BUY-010", "Sara Lee", "sara.lee@pcbk.com", "CUST-5001", "BR-PCBK-WEST", "CC-WEST-100", "BUYER", "ACTIVE", 120000, "USD", "Y", "PUNCH-PC-010"],
        ["BUY-900", "Tom Gray (suspended)", "tom.gray@glps.com", "CUST-1001", "BR-GLP-MW", "CC-MW-100", "BUYER", "SUSPENDED", 0, "USD", "N", ""],
     ],
    ...
    ("User_Permissions",
     ...
     [12, 18, 22, 40, 24, 14, 18]),

    ("Cost_Centers",
     "COST CENTERS  (validity, owning branch, status)",
     ["cost_center_id", "name", "branch_id", "status", "owner", "currency"],
     [
        ["CC-MW-100", "Midwest Operations", "BR-GLP-MW", "ACTIVE", "John Miller", "USD"],
        ["CC-MW-200", "Midwest Maintenance", "BR-GLP-MW", "ACTIVE", "Linda Park", "USD"],
        ["CC-NE-100", "Northeast Operations", "BR-GLP-NE", "ACTIVE", "Mark Snow", "USD"],
        ["CC-WEST-100", "West Operations", "BR-PCBK-WEST", "ACTIVE", "Sara Lee", "USD"],
        ["CC-OLD-900", "Decommissioned Center", "BR-GLP-MW", "INACTIVE", "-", "USD"],
     ],
     [16, 24, 16, 10, 16, 8]),
...
build_workbook("product-master-data.xlsx", [
    ("Product_Master",
     "PRODUCT MASTER  (variants, status, base UOM, material, finish, configuration)",
     ["sku", "description", "product_family", "status", "base_uom", "material",
      ...
      "country_of_origin"],
     [
        ["SKU-CTG-4520", "Ceramic Disc Faucet Cartridge, Single-Control", "CARTRIDGE", "ACTIVE", "EA", "Ceramic/Brass", "Single-Control", "Standard", "Y", "N", "", 12.50, "USD", 0.3, 7, "AquaCore", "USA"],
        ["SKU-DRN-3010", "Pop-Up Drain Assembly, Brushed Nickel", "DRAIN", "ACTIVE", "EA", "Solid Brass", "Grid Strainer", "1.25 in", "Y", "N", "", 45.00, "USD", 1.1, 10, "FlowFit", "USA"],
        ["SKU-VLV-2201", "Pressure-Balancing Shower Valve, 1/2 in", "VALVE", "ACTIVE", "EA", "Forged Brass", "Pressure-Balance", "1/2 in", "Y", "N", "", 88.00, "USD", 1.4, 14, "ThermoGuard", "USA"],
        ["SKU-SHS-7700", "Digital Shower Interface System", "SHOWERSYS", "ACTIVE", "EA", "Composite/Electronic", "Smart-Control", "Wall-Mount", "Y", "N", "", 1450.00, "USD", 6.5, 28, "AquaSmart", "USA"],
        ["SKU-FIN-9100", "Enameled Cast Iron Touch-Up Finish, White", "FINISH", "ACTIVE", "GAL", "Enamel Coating", "VOC-Grade", "1 qt", "N", "Y", "", 9.75, "USD", 1.2, 5, "FinishPro", "USA"],
        ["SKU-FIN-9200", "Cast Iron Touch-Up Aerosol, Almond (SDS pending)", "FINISH", "ACTIVE", "GAL", "Enamel Aerosol", "VOC-Grade", "12 oz", "N", "Y", "", 14.00, "USD", 0.5, 6, "FinishPro", "USA"],
        ["SKU-SEL-1150", "Tank-to-Bowl Gasket Kit", "SEAL", "ACTIVE", "EA", "Rubber/Foam", "Universal", "3 in", "N", "N", "", 6.25, "USD", 0.2, 4, "SealRight", "USA"],
        ["SKU-CTG-1000", "Legacy 2-Handle Faucet Cartridge (obsolete)", "CARTRIDGE", "OBSOLETE", "EA", "Brass", "Two-Handle", "Standard", "N", "N", "SKU-CTG-4520", 11.00, "USD", 0.3, 0, "AquaCore", "USA"],
        ["SKU-VLV-2000", "Discontinued Thermostatic Shower Valve (inactive)", "VALVE", "INACTIVE", "EA", "Cast Brass", "Thermostatic", "1/2 in", "N", "N", "SKU-VLV-2201", 70.00, "USD", 1.5, 0, "ThermoGuard", "USA"],
     ],
     [16, 40, 14, 10, 9, 18, 16, 12, 12, 10, 16, 11, 8, 10, 13, 12, 14]),
    ...
    ("Product_Attributes",
     ...
     [
        ...
        ["SKU-VLV-2201", "valve_type", "Pressure-Balance", "N", ""],
        ["SKU-SHS-7700", "voltage", "120V", "Y", ""],
        ["SKU-SHS-7700", "control_mode", "Touchscreen", "Y", ""],
        ["SKU-FIN-9100", "color", "White", "Y", ""],
     ],
     [16, 18, 18, 10, 14]),
    ...
    ("UOM_Conversions",
     ...
     [
        ["CASE", "EA", 24, "CARTRIDGE", "1 case = 24 cartridges"],
        ["EA", "CASE", 0.0416667, "CARTRIDGE", "each to case"],
        ["L", "GAL", 0.264172, "FINISH", "litres to US gallons"],
        ["GAL", "L", 3.78541, "FINISH", "US gallons to litres"],
        ["BOX", "EA", 12, "SEAL", "1 box = 12 each"],
        ["PR", "EA", 2, "DRAIN", "1 pair = 2 each"],
    ...
    ("Compatibility_Rules",
     ...
     [
        ["SKU-DRN-3010", "SKU-SEL-1150", "RECOMMENDED", "Drain assembly pairs with matching seal kit"],
        ["SKU-VLV-2201", "SKU-SHS-7700", "RECOMMENDED", "Shower valve pairs with digital interface system"],
        ["SKU-SHS-7700", "SKU-VLV-2201", "OPTIONAL", "Interface requires a compatible pressure-balance valve"],
     ],
     [16, 20, 14, 40]),
])
...
build_workbook("compliance-master-data.xlsx", [
    ("Compliance_Rules",
     ...
     [
        ["CMP-001", "SKU-FIN-9100", "FINISH", "REGIONAL", "CA", "RESTRICTED", "VOC limits in California (CARB)", "Y", "EPA/CARB"],
        ["CMP-002", "SKU-FIN-9100", "FINISH", "REGIONAL", "NY", "ALLOWED", "Permitted with SDS attached", "N", "EPA"],
        ["CMP-003", "", "FINISH", "EXPORT", "MX", "PROHIBITED", "Export licence required - not held", "Y", "Customs"],
        ["CMP-004", "SKU-SHS-7700", "SHOWERSYS", "REGIONAL", "ALL", "ALLOWED", "No restriction", "N", "-"],
     ],
     [10, 16, 14, 14, 12, 12, 32, 16, 12]),
    ...
    ("Regional_Restrictions",
     ...
     [
        ...
        ["NY", "New York", "", "Finishes allowed with SDS attached"],
        ["CA", "California", "FINISH", "VOC-restricted finishes require approval (CARB)"],
        ["MX", "Mexico", "FINISH", "Export licence required for finishes"],
     ],
     [12, 16, 20, 40]),
    ...
    ("SDS_Repository",
     ...
     [
        ["SKU-FIN-9100", "SDS-FIN-9100", "v4.2", "2025-02-01", "2027-02-01", "Class 3 Flammable", "Y", "sds/SKU-FIN-9100_v4.2.pdf"],
     ],
    ...
    ("Product_Eligibility",
     ...
     [
        ...
        ["SKU-FIN-9100", "IL", "Y", "SDS must be attached"],
        ["SKU-FIN-9100", "CA", "N", "Restricted - requires compliance approval"],
        ["SKU-FIN-9100", "MX", "N", "Export prohibited without licence"],
     ],
     [14, 10, 10, 34]),
])
...
build_workbook("pricing-master-data.xlsx", [
    ...
    ("Contracts",
     ...
     [
        ["CONTRACT-GLP-2026-007", "CUST-1001", "sku", "SKU-CTG-4520", 10.80, "USD", "2026-01-01", "2026-12-31", "ACTIVE"],
        ["CONTRACT-GLP-2026-007", "CUST-1001", "sku", "SKU-DRN-3010", 39.50, "USD", "2026-01-01", "2026-12-31", "ACTIVE"],
        ["CONTRACT-GLP-2026-007", "CUST-1001", "family", "VALVE", 80.00, "USD", "2026-01-01", "2026-12-31", "ACTIVE"],
        ["CONTRACT-GLP-2025-099", "CUST-1001", "sku", "SKU-SHS-7700", 1300.00, "USD", "2025-01-01", "2025-12-31", "EXPIRED"],
        ["CONTRACT-PCBK-2026-010", "CUST-5001", "family", "CARTRIDGE", 11.90, "USD", "2026-01-01", "2026-12-31", "ACTIVE"],
     ],
    ...
    ("Volume_Tiers",
     ...
     [
        ["VT-CTG-1", "family", "CARTRIDGE", 0, 499, 0, "EA"],
        ["VT-CTG-2", "family", "CARTRIDGE", 500, 1999, 5, "EA"],
        ["VT-CTG-3", "family", "CARTRIDGE", 2000, 999999, 10, "EA"],
        ["VT-DRN-1", "family", "DRAIN", 0, 99, 0, "EA"],
        ["VT-DRN-2", "family", "DRAIN", 100, 999, 4, "EA"],
    ...
    ("Rebates",
     ...
     [
        ["RB-GLP-01", "CUST-1001", "CARTRIDGE", 2.0, "Annual volume > 10000 EA"],
        ["RB-GLP-02", "CUST-1001", "ALL", 1.0, "Loyalty rebate"],
     ],
     [12, 16, 16, 12, 28]),
    ...
    ("Promotions",
     ...
     [
        ["PROMO-Q3-SEAL", "family", "SEAL", 8.0, "2026-06-01", "2026-09-30", "Q3 seal kit promotion"],
     ],
    ...
    ("Margin_Policy",
     ...
     [
        ["CARTRIDGE", 15, 18, "PRICING_MANAGER"],
        ["DRAIN", 18, 15, "PRICING_MANAGER"],
        ["VALVE", 20, 12, "PRICING_MANAGER"],
        ["SHOWERSYS", 22, 10, "PRICING_DIRECTOR"],
        ["SEAL", 25, 20, "PRICING_MANAGER"],
        ["FINISH", 12, 8, "PRICING_MANAGER"],
     ],
     [16, 14, 16, 18]),
    ...
    ("Raw_Material_Index",
     ...
     [
        ["Brass", "2026-06-01", 1.5, "Brass index up 1.5%"],
        ["Ceramic", "2026-06-01", 0.8, "Ceramic surcharge"],
        ["Enameled Cast Iron", "2026-06-01", 0.0, "No change"],
     ],
     [18, 14, 18, 24]),
])
...
build_workbook("budget-master-data.xlsx", [
    ("Budget_Master",
     ...
     [
        ["global_parent", "GP-CONT", "2026", 50000000, 18000000, 32000000, "USD"],
        ["regional_division", "RD-CONT-NA", "2026", 12000000, 5000000, 7000000, "USD"],
        ["branch", "BR-GLP-MW", "2026", 2000000, 1200000, 800000, "USD"],
        ["branch", "BR-GLP-NE", "2026", 1500000, 1400000, 100000, "USD"],
        ["branch", "BR-PCBK-WEST", "2026", 1800000, 600000, 1200000, "USD"],
     ],
     [16, 16, 10, 14, 14, 14, 8]),
    ...
    ("Approval_Matrix",
     ...
     [
        ["branch", "BR-GLP-MW", 0, 50000, "BRANCH_MANAGER", "Karen Wells", 24],
        ["regional_division", "RD-CONT-NA", 50001, 250000, "REGIONAL_MANAGER", "David Cho", 48],
        ["global_parent", "GP-CONT", 250001, 99999999, "CORPORATE_PROCUREMENT", "Procurement Board", 72],
        ["branch", "BR-PCBK-WEST", 0, 60000, "BRANCH_MANAGER", "Ana Reyes", 24],
     ],
...
build_workbook("credit-master-data.xlsx", [
    ...
    ("Invoice_Aging",
     ...
     [
        ["CUST-1001", "INV-GL-5501", 120000, "2026-06-30", 0, "OPEN"],
        ["CUST-1002", "INV-EK-6602", 95000, "2026-05-15", 42, "OVERDUE"],
        ["CUST-1002", "INV-EK-6610", 60000, "2026-05-30", 27, "OVERDUE"],
        ["CUST-7000", "INV-MT-9901", 200000, "2026-04-01", 86, "OVERDUE"],
     ],
     [16, 14, 12, 14, 14, 10]),
...
build_workbook("inventory-master-data.xlsx", [
    ...
    ("DC_Stock",
     ...
     ["location_id", "location_type", "region", "sku", "on_hand_qty", "uom"],
     [
        ["DC-CHI-01", "DC", "Midwest", "SKU-CTG-4520", 3000, "EA"],
        ["DC-CHI-01", "DC", "Midwest", "SKU-DRN-3010", 400, "EA"],
        ["DC-CHI-01", "DC", "Midwest", "SKU-VLV-2201", 30, "EA"],
        ["DC-CHI-01", "DC", "Midwest", "SKU-SEL-1150", 600, "EA"],
        ["DC-CHI-01", "DC", "Midwest", "SKU-SHS-7700", 8, "EA"],
        ["DC-DET-02", "DC", "Midwest", "SKU-CTG-4520", 1200, "EA"],
        ["DC-DET-02", "DC", "Midwest", "SKU-VLV-2201", 15, "EA"],
        ["DC-LA-05", "DC", "West", "SKU-CTG-4520", 2000, "EA"],
     ],
     [12, 14, 12, 14, 12, 8]),
    ...
    ("In_Transit",
     ...
     [
        ["SKU-VLV-2201", "PLANT-SHB", "DC-CHI-01", 40, "EA", "2026-07-05"],
        ["SKU-SHS-7700", "PLANT-SHB", "DC-CHI-01", 3, "EA", "2026-07-12"],
     ],
     [14, 14, 14, 10, 8, 14]),
...
build_workbook("logistics-master-data.xlsx", [
    ...
    ("Warehouse_Master",
     ...
     [
        ["DC-CHI-01", "Chicago DC", "60639", "Midwest", "HIGH", "16:00", "Midwest Freight,PrimeExpress"],
        ["DC-DET-02", "Detroit DC", "48201", "Midwest", "MEDIUM", "15:00", "Midwest Freight"],
        ["DC-LA-05", "Los Angeles DC", "90001", "West", "HIGH", "17:00", "Midwest Freight"],
     ],
     [14, 16, 10, 12, 10, 12, 24]),
...
build_workbook("execution-master-data.xlsx", [
    ...
    ("Document_Repository",
     ...
     [
        ["DOC-SDS-FIN", "SDS", "SKU-FIN-9100", "sds/SKU-FIN-9100_v4.2.pdf"],
